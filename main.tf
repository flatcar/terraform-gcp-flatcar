...
locals {
  image_map = {
    "stable" = "flatcar-stable-4459-2-3"
    "beta"   = "flatcar-beta-4547-1-0"
    "alpha"  = "flatcar-alpha-4593-0-0"
  }

  flatcar_image = var.flatcar_image == "" ? "projects/kinvolk-public/global/images/${lookup(local.image_map, var.channel, "flatcar-stable-4459-2-3")}" : var.flatcar_image
